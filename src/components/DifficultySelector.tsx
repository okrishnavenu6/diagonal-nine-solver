  ...
  return (
    <div className="liquid-glass rounded-2xl shadow-2xl p-4 md:p-6 space-y-4 border border-primary/40 hover:border-primary/60 transition-all duration-300">
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary via-primary to-accent flex items-center justify-center shadow-[0_0_20px_rgba(var(--primary-rgb),0.4)]">
          <Flame className="w-6 h-6 text-white drop-shadow-lg" />
        </div>
        <h3 className="font-black text-foreground text-lg uppercase tracking-wider drop-shadow-sm">Difficulty</h3>
      </div>
