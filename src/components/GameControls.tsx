...
export const GameControls = ({
  ...
  return (
    <div className="group relative bg-gradient-to-br from-card via-card to-card/50 rounded-3xl shadow-[0_8px_40px_rgba(0,0,0,0.4)] p-5 md:p-7 space-y-4 border-2 border-primary/40 backdrop-blur-2xl hover:border-primary/60 transition-all duration-500 hover:shadow-[0_0_60px_rgba(var(--primary-rgb),0.4)]">
      ...
      <div className="relative grid grid-cols-2 gap-3">
        <button
          onClick={onUndo}
          disabled={!canUndo}
          className="flex items-center justify-center gap-2 bg-gradient-to-br from-secondary to-secondary/80 text-secondary-foreground py-3 px-4 rounded-xl font-bold hover:from-secondary/90 hover:to-secondary disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-[1.08] active:scale-95 shadow-lg hover:shadow-xl border border-secondary/50"
        >
      ...
      <div className="relative grid grid-cols-2 gap-3">
        <button
          onClick={onHint}
          className="flex items-center justify-center gap-2 bg-gradient-to-br from-accent to-accent/80 text-accent-foreground py-3 px-4 rounded-xl font-bold hover:from-accent/90 hover:to-accent transition-all duration-300 transform hover:scale-[1.08] active:scale-95 shadow-lg hover:shadow-[0_0_20px_rgba(239,65,60,0.5)] border border-accent/50"
        >
      ...
      <button
        ...
        className={cn(
          "relative w-full flex items-center justify-center gap-3 py-4 px-6 rounded-2xl font-black text-lg transition-all duration-300 shadow-lg transform hover:scale-[1.05] active:scale-95 border-2 overflow-hidden group/pencil",
          {
            "bg-gradient-to-r from-primary to-accent text-primary-foreground shadow-[0_0_25px_rgba(99,102,241,0.6)] hover:shadow-[0_0_35px_rgba(99,102,241,0.8)] border-primary/50": isPencilMode,
